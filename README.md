...
* [ArcadeDB](https://arcadedb.com/) - open-source multi-model database supporting graphs, documents, key-value, time series and vector embeddings with SQL, Cypher, Gremlin and GraphQL query languages 
